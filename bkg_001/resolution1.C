void resolution1(){
  ...
  char  dataafile[]="DATA/finalEnergyerror1.dat";//A,mean,sigma,error in A,error in mean, error in sigma,N for final fit
  char pdfresoluton[]="PLOTS/resolutionplot1.pdf"; //pdf file to save the plot
  const   char* finalresults="DATA/results_from_resolution1.dat";//stores the results obtained form the resolution plot
