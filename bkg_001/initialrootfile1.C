...
void initialrootfile1(){
  ...
  //Defining the files
  const char * root_file="ROOTFILES/initial1.root"; //for storing the histogram in root
  const char * inputdatafile="DATA/bkg_001.dat"; //file with input data
  const char * histopdf="PLOTS/initialhisto1.pdf";//initial histogram as pdf file
