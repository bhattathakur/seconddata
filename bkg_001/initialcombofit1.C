void initialcombofit1(){
  // gROOT->Reset();
  //Files for storing data file
  const char * filename="ROOTFILES/initial1.root"; //access the original histogram
  const char * allhistogramsfile="ROOTFILES/initial_allhistogram1.root"; //Save the histogram in this root file
  char  file_estimated_parameters[]="DATA/initialestimates.dat"; //file stores  the estimated parameters for fit
  char  outputfile[] ="DATA/initialEnergyerror1.dat"; //file storing errors 
