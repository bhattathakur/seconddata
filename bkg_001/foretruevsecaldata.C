foretruevsecaldata(){
  ...
  const char * input1="DATA/initialEnergyerror.dat"; //estimated energy from the fit parameters
  const  char * input2="DATA/tabulatedenergy.dat"; //true energy calculated from nudat2
  const char * output="DATA/E_estandE_true.dat";//storing the data manipulated from input1 and input2
