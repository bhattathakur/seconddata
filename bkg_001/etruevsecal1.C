void etruevsecal1()
{
  const char * filedata="DATA/E_estandE_true1.dat"; //File storing the estimated and true energy and their errors
  const char * rootfile="ROOTFILES/true_estimated_enregyplot1.root"; //root file to save the plot
  const char * filenamee="DATA/slope_intercept1.dat"; //file to store slope and intercept of plot
