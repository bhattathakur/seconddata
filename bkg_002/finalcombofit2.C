void finalcombofit2(){
  ...
  const char * filname="ROOTFILES/final2.root"; //access the original histogram
  const  char * finalallhistograms="ROOTFILES/final_allhistogram2.root";
  char  estimated_parameter_files[]="DATA/finalestimates.dat"; //file storing the estimated parameters for fit
  char  finaloutputfile[] ="DATA/finalEnergyerror2.dat"; //Output file to store A,u,6,eA,eu,e6
