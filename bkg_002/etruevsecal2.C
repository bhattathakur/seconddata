void etruevsecal2()
{
  const char * filedata="DATA/E_estandE_true2.dat"; //File storing the estimated and true energy and their errors
  const char * rootfile="ROOTFILES/true_estimated_enregyplot2.root"; //root file to save the plot
  const char * filenamee="DATA/slope_intercept2.dat"; //file to store slope and intercept of plot
