...
void initialrootfile2(){
  ...
  //Defining the files
  const char * root_file="ROOTFILES/initial2.root"; //for storing the histogram in root
  const char * inputdatafile="DATA/bkg_002.dat"; //file with input data
  const char * histopdf="PLOTS/initialhisto2.pdf";//initial histogram as pdf file
