...
void finalrootfile2(){
   //Defining the files
  const char * root_file="ROOTFILES/final2.root"; //Stores the root file
  const char * inputdatafile="DATA/bkg_002.dat"; //original data files which stores two columns of data
  const char * intercept_slopefile="DATA/slope_intercept2.dat"; //This file contains the slope and intercept data created by etruevsecal macro
