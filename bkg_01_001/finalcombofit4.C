void finalcombofit4(){
  ...
  const char * filname="ROOTFILES/final4.root"; //access the original histogram in the name of finalhisto
  const  char * finalallhistograms="ROOTFILES/final_allhistogram4.root";
  char  estimated_parameter_files[]="DATA/finalestimates.dat"; //file storing the estimated parameters for fit
  char  finaloutputfile[] ="DATA/finalEnergyerror4.dat"; //Output file to store A,u,6,eA,eu,e6
