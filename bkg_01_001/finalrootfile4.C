...
void finalrootfile4(){
   //Defining the files
  const char * root_file="ROOTFILES/final4.root"; //Stores the root file
  const char * inputdatafile="DATA/bkg_01_001.dat"; //original data files which stores two columns of data
  const char * intercept_slopefile="DATA/slope_intercept4.dat"; //This file contains the slope and intercept data created by etruevsecal macro
