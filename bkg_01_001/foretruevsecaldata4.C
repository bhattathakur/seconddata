void foretruevsecaldata4(){
  //Data File contaiing estimated energy and true energy
  const char * input1="DATA/initialEnergyerror4.dat"; //estimated energy from the fit parameters
  const  char * input2="DATA/tabulatedenergy.dat"; //true energy calculated from nudat2
  const char * output="DATA/E_estandE_true4.dat";//stores the  data manipulated from input1 and input2
