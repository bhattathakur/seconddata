...
void initialrootfile4(){
  ...
  //Defining the files
  const char * root_file="ROOTFILES/initial4.root"; //for storing the histogram in rootbkg_01_000.dat
  const char * inputdatafile="DATA/bkg_01_001.dat"; //file with input data
  const char * histopdf="PLOTS/initialhisto4.pdf";//initial histogram as pdf file
