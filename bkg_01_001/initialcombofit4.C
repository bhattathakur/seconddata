void initialcombofit4(){
  // gROOT->Reset();
  //Files for storing data file
  const char * filename="ROOTFILES/initial4.root"; //access the original histogram
  const char * allhistogramsfile="ROOTFILES/initial_allhistogram4.root"; //Save the histogram in this root file
  char  file_estimated_parameters[]="DATA/initialestimates.dat"; //file stores  the estimated parameters for fit
  char  outputfile[] ="DATA/initialEnergyerror4.dat"; //file storing errors 
