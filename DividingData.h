 ...
 */
void DividingData(TString basicinputfile,Int_t rowNumber)
  {
    // TString basicinputfile="TimeInterceptSlopeResolution";
    ...
    TString file1 = basicinputfile+"1.dat",
            file2 = basicinputfile+"2.dat";

    //Checking the opening of output files
    ofstream output1(file1),
	       output2(file2);
    ...
    {
	cout<<line<<endl;
	if(rowCount<rowNumber)output1<<line<<endl;
