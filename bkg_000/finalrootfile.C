...
finalrootfile(){
   //Defining the files
  const char * root_file="ROOTFILES/final.root"; //Stores the root file
  const char * inputdatafile="DATA/bkg_000.dat"; //original data files which stores two columns of data
