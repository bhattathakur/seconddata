...
initialrootfile(){
  ...
  //Defining the files
  const char * root_file="ROOTFILES/initial.root"; //for storing the histogram in root
  const char * inputdatafile="DATA/bkg_000.dat"; //file with input data
  const char * histopdf="PLOTS/initialhisto.pdf";
