void finalcombofit3(){
  ...
  const char * filname="ROOTFILES/final3.root"; //access the original histogram
  const  char * finalallhistograms="ROOTFILES/final_allhistogram3.root";
  char  estimated_parameter_files[]="DATA/finalestimates.dat"; //file storing the estimated parameters for fit
  char  finaloutputfile[] ="DATA/finalEnergyerror3.dat"; //Output file to store A,u,6,eA,eu,e6
