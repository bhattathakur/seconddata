...
void finalrootfile3(){
   //Defining the files
  const char * root_file="ROOTFILES/final3.root"; //Stores the root file
  const char * inputdatafile="DATA/bkg_01_000.dat"; //original data files which stores two columns of data
  const char * intercept_slopefile="DATA/slope_intercept3.dat"; //This file contains the slope and intercept data created by etruevsecal macro
