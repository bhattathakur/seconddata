void resolution3(){
  ...
  char  dataafile[]="DATA/finalEnergyerror3.dat";//A,mean,sigma,error in A,error in mean, error in sigma,N for final fit
  char pdfresoluton[]="PLOTS/resolutionplot3.pdf"; //pdf file to save the plot
  const   char* finalresults="DATA/results_from_resolution3.dat";//stores the results obtained form the resolution plot
  const  char* savingtoroot="ROOTFILES/resolution3.root";// saves the plot in the root file
